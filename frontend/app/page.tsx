          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-emerald-500 rounded-lg flex items-center justify-center text-sm font-extrabold">
                  S
                </div>
                <span className="font-extrabold text-lg tracking-tight">SmartHealth</span>
              </div>
              <p className="text-blue-200 text-sm leading-relaxed max-w-xs">
                Sri Lanka&apos;s leading digital healthcare platform connecting patients with
