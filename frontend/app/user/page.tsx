...
return ( <main className="mx-auto flex min-h-screen max-w-4xl flex-col gap-6 px-6 py-10"> <PageHeader
     title="User Profile"
      ...
      {user.role === "Undefined" && (
        <Card title="Complete Account Setup">
          <p className="text-sm text-gray-600 mb-4">
            Register to continue using SmartHealth.
          </p>

          <div className="flex flex-col gap-3">
            <Button
              onClick={handlePatientSetup}
