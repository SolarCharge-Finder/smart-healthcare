  ...
  return (
    <Card title={doctor.doctorName}>
      <div className="space-y-2 text-sm text-gray-700">
        ...
        <p>
          <span className="font-semibold">Doctor Fee:</span> Rs. {doctor.pricing.doctorFee.toFixed(2)}
        </p>
        {!hideHospitalFields ? (
          <p>
            <span className="font-semibold">Hospital Fee:</span> Rs. {doctor.pricing.hospitalFee.toFixed(2)}
          </p>
        ) : null}
        <p>
          <span className="font-semibold">eChannelling Fee:</span> Rs. {doctor.pricing.eChannellingFee.toFixed(2)}
        </p>
      </div>
      ...
      <div className="mt-4">
        <Button
          type="button"
          onClick={() => onBookNow(selectedSlot)}
